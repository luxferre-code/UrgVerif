...
RUN git clone https://github.com/luxferre-code/UrgVerif.git .
...
COPY --from=build /app/WEB-INF/view /usr/local/tomcat/webapps/ROOT/WEB-INF/view
...
COPY --from=build /app/install_vsav.sql /usr/local/tomcat/webapps/ROOT/install_vsav.sql
